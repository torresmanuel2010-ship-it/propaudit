    ...
    <>
      ...
      <div style={{ backgroundColor: '#f8fafc', minHeight: '100vh', padding: '40px 20px', fontFamily: 'system-ui, -apple-system, sans-serif', color: '#0f172a' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          {/* Resultados */}
          {result && (
            <div className="pdf-container" style={{ backgroundColor: '#ffffff', padding: '32px', borderRadius: '16px', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1)' }}>
              
              {/* Encabezado visible solo en PDF */}
              <div className="pdf-header" style={{ display: 'none' }}>
                <div style={{ color: '#2563eb', fontWeight: 'bold', fontSize: '12px', textTransform: 'uppercase' }}>PropAudit Pro — Informe de Rendimiento</div>
                <h1 style={{ fontSize: '22px', margin: '4px 0' }}>Auditoría Técnica e Impacto de Negocio</h1>
              </div>
